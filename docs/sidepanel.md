...
behavior, and Home Assistant details. Fields that do not apply to the chosen
cover or climate control mode are hidden automatically. Climate preset mappings
