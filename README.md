...
- 🕒 **Schedule dashboard card**: Edit BCD WORD or HHMM on/off times with a visual card editor, automatically loaded with the integration ([guide](docs/schedule-card.md))
