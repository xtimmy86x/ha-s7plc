...
.address-builder{grid-column:1/-1;min-width:0;margin:0;padding:16px;border:1px solid var(--divider-color);border-radius:14px}.address-builder legend{display:flex;align-items:center;gap:10px;padding:0 5px;font-weight:600}.address-builder legend em{font-size:9px;font-style:normal;text-transform:uppercase;letter-spacing:.06em;color:var(--primary-color)}.address-modes{display:inline-flex;gap:3px;margin:2px 0 14px;padding:3px;border-radius:10px;background:var(--secondary-background-color)}.address-modes button{padding:7px 14px;border-radius:8px;font-weight:600;opacity:.7}.address-modes button.active{color:var(--primary-color);background:var(--card-background-color);box-shadow:0 1px 4px #00000024;opacity:1}.address-controls{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,150px),1fr));gap:12px 14px}.address-controls label{min-width:0}.address-controls input,.address-controls select,.address-manual input{box-sizing:border-box;width:100%;min-width:0}.address-preview{display:flex;align-items:baseline;justify-content:space-between;gap:14px;margin-top:14px;padding:10px 12px;border-radius:10px;background:var(--secondary-background-color)}.address-preview code{min-width:0;overflow-wrap:anywhere;text-align:right}.address-manual{margin-top:2px}.address-error,.address-help{display:block;margin-top:10px}.address-error{color:var(--error-color)!important}.address-builder:focus{outline:2px solid var(--error-color);outline-offset:2px}.address-builder [hidden]{display:none!important}
