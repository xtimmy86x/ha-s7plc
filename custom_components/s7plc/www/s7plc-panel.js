...
.light-options .control-card,.compact-control-card{min-height:110px;padding:12px 14px!important;gap:6px!important}.cover-options{grid-template-columns:repeat(auto-fit,minmax(135px,1fr));grid-auto-rows:max-content}.compact-control-card{align-items:center!important;text-align:center}.compact-control-card small{margin-top:3px}
